...
<div class="py-3 mb-4 shadow-sm bg-warning border-top">
    <div class="container">
        <h6 class="mb-0"><a class = "text-black text-decoration-underline" href="{{url('/')}}">Home</a> / Cart</h6>
    </div>
</div>
...
<div class="container my-5">
   ...
   <a href="{{url('category/'.$item ->product->category->slug.'/'.$item->product->slug)}}"><img src="{{asset('assets/uploads/products/'.$item->product->image)}}" height="150px" width="100px" class="w-100"></a>
                </div>
                ...
                <div class="col-md-2 my-auto">
                    ...
                    <div class="col-md-2 my-auto">
                        <button class="btn btn-danger mt-2 delete-cart-item"> <i class="fa fa-trash">  </i>    Remove</button>
                    </div> 
                </div>
                @endforeach
            </div>
